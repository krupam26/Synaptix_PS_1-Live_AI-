...
print("7. Loading local embeddings (this may take 20-40 seconds first time)...")

embedder = embedders.SentenceTransformerEmbedder(model_name="all-MiniLM-L6-v2")

print("8. Embedder loaded – building index...")
...
print("9. Creating document store...")
...
print("10. Document store ready")

# -----------------------------
# LangChain + LLM
# -----------------------------
print("11. Connecting to Pathway vector client...")
